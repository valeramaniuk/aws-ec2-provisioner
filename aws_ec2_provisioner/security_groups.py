...
def _create_elb_security_group(project_name, vpc_id, client):
    ...
    _authorize_sg_ingress(elb_sg_name, in_permissions, client)
...
def _create_application_security_group(project_name, vpc_id, client, source_sg):
    ...
    _authorize_sg_ingress(app_sg_name, in_permissions, client, source_sg=source_sg)
...
def _authorize_sg_ingress(security_group_name, in_permissions, client, source_sg=None):
    try:
        if source_sg:
